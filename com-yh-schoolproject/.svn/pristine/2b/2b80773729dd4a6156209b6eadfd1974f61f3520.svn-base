...
function(a, b) {
    ...
    function E(a, b, c) {
        ...
        }) : D.test(b) ? r.filter(b, a, c) : (b = r.filter(b, a), r.grep(a,
        function(a) {
    ...
    r.Callbacks = function(a) {
        a = "string" == typeof a ? M(a) : r.extend({},
        a);
        var b, c, d, e, f = [],
        g = [],
        h = -1,
    ...
    r.extend({
        isReady: !1,
        readyWait: 1,
        ready: function(a) { (a === !0 ? --r.readyWait: r.isReady) || (r.isReady = !0, a !== !0 && --r.readyWait > 0 || R.resolveWith(d, [r]))
        }
    }),
    r.ready.then = R.then;
    function S() {
    ...
    r.fn.extend({
        ...
        promise: function(a, b) {
            ...
            a = a || "fx";
            while (g--) c = W.get(f[g], a + "queueHooks"),
    ...
    function oa(a, b) {
        for (var c = 0,
        d = a.length; c < d; c++) W.set(a[c], "globalEval", !b || W.get(b[c], "globalEval"))
    }
    var pa = /<|&#?\w+;/;
    ...
    r.event = {
        ...
        special: {
            ...
            focus: {
                trigger: function() {
                    if (this !== xa() && this.focus) return this.focus(),
                    !1
                },
            ...
            blur: {
                trigger: function() {
                    if (this === xa() && this.blur) return this.blur(),
                    !1
                },
    ...
    function Ha(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            X.hasData(a) && (h = X.access(a), i = r.extend({},
            h), X.set(b, i))
        }
    }
    function Ia(a, b) {
    ...
    function Ja(a, b, c, d) {
        ...
        if (m && (e = qa(b, a[0].ownerDocument, !1, a, d), f = e.firstChild, 1 === e.childNodes.length && (e = f), f || d)) {
            for (h = r.map(na(e, "script"), Fa), i = h.length; l < m; l++) j = e,
    ...
    function(a, b) {
        r.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return ! Qa.test(r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width ? $a(a, b, d) : ea(a, Sa,
                function() {
                    return $a(a, b, d)
                })
            },
    ...
    r.cssHooks.marginLeft = Pa(o.reliableMarginLeft,
    function(a, b) {
    ...
    r.speed = function(a, b, c) {
        var d = a && "object" == typeof a ? r.extend({},
        a) : {
    ...
    r.fx.tick = function() {
        var a, b = 0,
        c = r.timers;
        for (ab = r.now(); b < c.length; b++) a = c[b],
        ...
        val: function(a) {
            var b, c, d, e = this[0]; {
                ...
                this.each(function(c) {
                    var e;
                    1 === this.nodeType && (e = d ? a.call(this, c, r(this).val()) : a, null == e ? e = "": "number" == typeof e ? e += "": Array.isArray(e) && (e = r.map(e,
                    function(a) {
                        return null == a ? "": a + ""
    ...
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            ...
            if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !sb.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, b = b[r.expando] ? b: new r.Event(p, "object" == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = q.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : r.makeArray(c, [b]), n = r.event.special[p] || {},
    ...
    r.param = function(a, b) {
        ...
        if (Array.isArray(a) || a.jquery && !r.isPlainObject(a)) r.each(a,
        function() {
