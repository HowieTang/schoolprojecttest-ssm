...
<link rel="stylesheet" href="<%=basePath %>static/plugin/News/css/style2.css">
<link rel="stylesheet" href="<%=basePath %>static/plugin/News/css/comment.css">
...
<script type="text/javascript" src="<%=basePath %>static/plugin/News/js/jquery-1.12.0.min.js"></script>
<script type="text/javascript" src="<%=basePath %>static/plugin/News/js/jquery.flexText.js"></script>
			...
			<div class="col-md-6 content-left single-post">
				<c:forEach items="${map.news}" var="newss">
					<div class="blog-posts">
						<!-- 新闻标题 -->
						<a href="<%=basePath %>news/lookCampusTrends?news_id=${newss.news_id}"><h3 class="post" name="title">${newss.title }</h3></a>				
						<div class="clearfix"></div>
					</div>
				</c:forEach>
