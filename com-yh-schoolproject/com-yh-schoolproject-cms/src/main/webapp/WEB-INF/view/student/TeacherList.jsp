...
<title>Insert title here</title>
 ...
 <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form id="queryForm" action="<%=basePath %>teacher/queryList" method="post" class="layui-form layui-col-md12 x-so">
		  ...
		  <!-- 模糊查询 -->
		  <input  name="tname" type="text"  placeholder="请输入老师名" autocomplete="off" class="layui-input" value="${map.teacher.tname }"/>
	        ...
	        <tbody>
	        	<c:forEach items="${map.page.list }" var="t">
	        		<tr>
	        			...
	        			<td>${t.teach }</td>
	        			<%-- <td class="td-manage">
							<a href="<%=basePath %>teacher/bfaddOrUpdate?tid=${t.teacherId}" class="layui-btn-danger layui-btn layui-btn-xs">添加</a>     
	            		</td>    --%> 
	        		</tr>
	         </c:forEach>
	        </tbody>
